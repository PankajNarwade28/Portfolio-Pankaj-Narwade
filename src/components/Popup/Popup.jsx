        ...
        <div className="popup-content">
          ...
          <div className="popup-info">
            ...
            <div className="popup-social-links">
              <a 
                href="https://github.com/PankajNarwade28" 
                target="_blank" 
                rel="noopener noreferrer"
                className="popup-social-icon popup-social-icon-github"
                aria-label="GitHub"
              >
              ...
              <a 
                href="https://www.linkedin.com/in/pankaj-narwade-13a053260/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="popup-social-icon popup-social-icon-linkedin"
                aria-label="LinkedIn"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a 
                href="https://www.instagram.com/pankajnarwade.patil/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="popup-social-icon popup-social-icon-instagram"
